      ...
      <div class="col-md-12">
        <vnud-card>
          <div>
            ...
            <n-button loading :disabled="multipleSelection.length === 0" type="info" size="lg" @click="makeActive()">Make Active</n-button>
          </div>
...
export default {
  ...
  methods: {
    ...
    makeActive() {
      for(let i = 0; i < this.multipleSelection.length; i++) {
        this.multipleSelection[i].status = "active"
      }
      this.$refs.table.clearSelection()
    },
